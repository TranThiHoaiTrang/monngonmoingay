    ...
    <header id="header"
        ...
        <div
            ...
            <div
                ...
                <span class="hidden lg:block italic text-xs absolute -top-6 -left-8">Đăng ký thành viên để hưởng ưu đãi ...</span>
...
<section id="banner" class="container mt-4 relatives z-20">
    <div class="banner-slider lg:rounded-xl overflow-hidden w-full aspect-auto lg:aspect-[1280/320]">
    ...
    <div id="search"
        ...
        <h2 class="lobster text-2xl">10.000+ Recipes From Chef...</h2>
...
do_action( 'ehd_cookingfornutrition_post' );
