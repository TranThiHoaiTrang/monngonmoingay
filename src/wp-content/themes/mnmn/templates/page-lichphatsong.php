...
<header id="header"
    ...
    <h1 id="logo" class="p-1 bg-white rounded-[10px]">
        <a href="/">
            <img src="/images/logo.png" srcset="/images/logo.png 1x, /images/logo@2x.png 2x" class="w-24 lg:w-20"
    ...
    <div
        class="nav-wrap flex lg:justify-start lg:items-center flex-auto fixed lg:static top-0 right-0 flex-col lg:flex-row h-dvh lg:h-auto w-screen lg:w-auto justify-between pointer-events-none lg:pointer-events-auto">
        ...
        <nav id="mainNav"
            ...
            <ul class="flex items-start lg:items-center flex-col lg:flex-row gap-1 lg:gap-0">
                ...
                <li
                    class=" group items-center lg:px-2 py-2 lg:py-0 lg:border-r border-[var(--Gray-03)] text-[var(--Gray-01)] hover:text-[var(--Primary-02)] relative first:pl-0 self-stretch justify-between">
                    <a href="/cooking-with-experts.html"
                ...
                <li
                    class=" group items-center lg:px-2 py-2 lg:py-0 lg:border-r border-[var(--Gray-03)] text-[var(--Gray-01)] hover:text-[var(--Primary-02)] relative first:pl-0 self-stretch justify-between">
                    <a href="/broadcast-schedule-master.html"
                       class="flex items-center gap-1 h-full self-stretch justify-between">
                        Lịch phát sóng
                    </a>
                </li>
...
<section id="banner" class="container mt-4 relatives z-20 px-4">
        ...
        <form class="w-full flex gap-4 items-center justify-between" action="/tim-kiem-mon-ngon/">
            ...
            <div class="relative w-full">
                ...
                <div id="accordion-advanced-search" data-active-classes="bg-white text-[var(--Primary-02)]"
                     ...
                     class="advanced-search visible opacity-0 transition-all fixed h-dvh lg:h-auto lg:absolute inset-x-0 top-0 lg:top-16 bg-white lg:rounded-2xl p-4 pr-0 z-10 pointer-events-none group-has-[.advanced]:opacity-100 group-has-[.advanced]:pointer-events-auto">
                    ...
                    <div
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <h2 id="accordion-flush-heading-cachnau">
                                <button type="button"
                                        class="flex items-center justify-between w-full gap-3 font-bold pb-4"
                                        data-accordion-target="#accordion-flush-body-cachnau" aria-expanded="true"
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <h2 id="accordion-flush-heading-dipnau">
                                <button type="button"
                                        class="flex items-center justify-between w-full gap-3 font-bold pb-4"
                                        data-accordion-target="#accordion-flush-body-dipnau" aria-expanded="true"
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <h2 id="accordion-flush-heading-loaimon">
                                <button type="button"
                                        class="flex items-center justify-between w-full gap-3 font-bold pb-4"
                                        data-accordion-target="#accordion-flush-body-loaimon" aria-expanded="true"
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <h2 id="accordion-flush-heading-giadinh">
                                <button type="button"
                                        class="flex items-center justify-between w-full gap-3 font-bold pb-4"
                                        data-accordion-target="#accordion-flush-body-giadinh" aria-expanded="true"
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <h2 id="accordion-flush-heading-vungmien">
                                <button type="button"
                                        class="flex items-center justify-between w-full gap-3 font-bold pb-4"
                                        data-accordion-target="#accordion-flush-body-vungmien" aria-expanded="true"
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <h2 id="accordion-flush-heading-dinhduong">
                                <button type="button"
                                        class="flex items-center justify-between w-full gap-3 font-bold pb-4"
                                        data-accordion-target="#accordion-flush-body-dinhduong" aria-expanded="true"
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <h2 id="accordion-flush-heading-nuoccham">
                                <button type="button"
                                        class="flex items-center justify-between w-full gap-3 font-bold pb-4"
                                        data-accordion-target="#accordion-flush-body-nuoccham" aria-expanded="true"
                        ...
                        <div class="advanced-group p-4 pb-0 border border-[var(--Gray-03)] rounded-lg"
                            ...
                            <div id="accordion-flush-body-giavi"
                                ...
                                <div class="flex flex-wrap justify-start border-b pb-4 last:pb-0 last:border-none">
                                    <label class="flex items-center gap-2 flex-[0_1_25%] cursor-pointer text-xs lg:text-sm py-1">
                                        <input type="checkbox" value="aji-quick-ca-kho-rieng-gia-vi-nem-san" name=""
                                               class="w-4 h-4 text-[var(--Primary-02)] focus:ring-0 border-[var(--Neutral-05)] rounded-sm">
                                    ...
                                    <label class="flex items-center gap-2 flex-[0_1_25%] cursor-pointer text-xs lg:text-sm py-1">
                                        <input type="checkbox" value="aji-quick-gia-vi-nem-san-lau-kim-chi" name=""
                                               class="w-4 h-4 text-[var(--Primary-02)] focus:ring-0 border-[var(--Neutral-05)] rounded-sm">
                                    ...
                                    <label class="flex items-center gap-2 flex-[0_1_25%] cursor-pointer text-xs lg:text-sm py-1">
                                        <input type="checkbox" value="aji-quick-bun-bo-hue-gia-vi-nem-san" name=""
                                               class="w-4 h-4 text-[var(--Primary-02)] focus:ring-0 border-[var(--Neutral-05)] rounded-sm">
                                    ...
                                    <label class="flex items-center gap-2 flex-[0_1_25%] cursor-pointer text-xs lg:text-sm py-1">
                                        <input type="checkbox" value="aji-quick-thit-kho-tau-gia-vi-nem-san" name=""
                                               class="w-4 h-4 text-[var(--Primary-02)] focus:ring-0 border-[var(--Neutral-05)] rounded-sm">
                                ...
                                <div class="flex flex-wrap justify-start border-b pb-4 last:pb-0 last:border-none">
                                    ...
                                    <label class="flex items-center gap-2 flex-[0_1_25%] cursor-pointer text-xs lg:text-sm py-1">
                                        <input type="checkbox" value="banh-ran-pha-san-bua-sang-dinh-duong" name=""
                                               class="w-4 h-4 text-[var(--Primary-02)] focus:ring-0 border-[var(--Neutral-05)] rounded-sm">
...
do_action( 'ehd_lichphatsong_post' );
